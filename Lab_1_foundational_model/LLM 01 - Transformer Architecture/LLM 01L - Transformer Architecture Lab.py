...
# Compute embeddings and cosine similarity
embeddings1 = sentence_to_embeddings(sentence_q4a, model, word2id)
embeddings2 = sentence_to_embeddings(sentence_q4b, model, word2id)
...
sentence_q5 =  "The [MASK] sat on the [MASK]."
print(predict_masked_words(sentence, mlm_model, tokenizer))
...
sentence_q6 = "Comment [MASK] vous aider?"
...
# TODO
# Define two sentences where a word has different meanings
sentence_q7a = "She tied her hair up with a ribbon and made a little [MASK]."
sentence_q7b = "Pierre slung the [MASK] and arrows over his shoulder and trudged into the forest"
...
sentence_q8 = "She wore a red [MASK] on her forehead, signifying her marital status and invoking the blessings of the goddess Parvati"
...
sentence_q9 = "He decided to let the [MASK] out of the bag and reveal the surprise party plans to everyone"
